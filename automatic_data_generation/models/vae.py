...
class SentenceVAE(nn.Module):
    ...
    def __init__(self, vocab_size, embedding_size, rnn_type, hidden_size,
                 word_dropout, embedding_dropout, latent_size,
        ...
        self.decoder_rnn = rnn(
            ...
            bidirectional=self.bidirectional,
            batch_first=True
        )  # weird to have bidirectional decoder
    ...
    def forward(self, input_sequence, length):
        ...
        logp = nn.functional.log_softmax(self.outputs2vocab(
            padded_outputs.view(-1, padded_outputs.size(2))), dim=-1)
    ...
    def inference(self, n=4, z=None):
        ...
        sequence_idx = torch.arange(0, batch_size,
                                    out=self.tensor()).long()  # all idx of batch
